// src/domain/payment/payment-calculator.test.ts
...
describe('calculatePayment', () => {
  ...
  it('handles large numbers without precision loss (long hearing)', () => {
    // 8-hour hearing at high rate — should not overflow or round incorrectly
    const result = calculatePayment({
      durationMin: 480,
