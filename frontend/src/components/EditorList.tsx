...
export function EditorList({
    ...
    const availableFilter = useEditorStore((s) => s.availableFilter);
    ...
    return (
        <main
            className={[
                ...
                selectedEditorId ? "hidden md:flex" : "flex",
            ].join(" ")}
        >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
                {error ? (
                    ...
                    <EmptyState
                        ...
                        body="Try adjusting your search or filters, or add a new editor."
                    />
                ) : (
                    editors.map((editor) => {
                        const isSelected = editor.id === selectedEditorId;
                        return (
                            <EditorCard
                                key={editor.id}
                                editor={editor}
